...
urlpatterns = [
    ...
    path('edit_deal/<int:pk>/', EditAdditionView.as_view(), name='edit_deal'),
    path('delete_deal/<int:pk>/', DeleteAdditionView.as_view(), name='delete_deal'),
    ...
    path('save_current_price/', save_current_price, name='save_current_price'),
